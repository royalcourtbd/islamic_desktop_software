...
class HadithAppSwitchButton extends StatefulWidget {
  ...
  Color toggleColor = const Color(0xff3D4953).withOpacity(0.5);
...
class HadithAppSwitchButtonState extends State<HadithAppSwitchButton>
  ...
  @override
  void didUpdateWidget(HadithAppSwitchButton oldWidget) {
              ...
              child: Opacity(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color:
                        Get.isDarkMode ? const Color(0xff474747) : switchColor,
                    border: switchBorder,
                  ),
                  child: Stack(
                    children: <Widget>[
